...
import fpp.lab12.exceptions.IllegalTriangleException;
...
public class Triangle extends ClosedCurve {
    ...
    public Triangle(double side1, double side2, double side3) throws IllegalTriangleException {
        ...
        if (x + y < z) {
            ...
            throw new IllegalTriangleException("Illegal sizes for a triangle");
        } else {
            setSides(x, y, z);
    ...
    public static void main(String[] args) {
        ...
        try {
            Triangle t = new Triangle(1.41421, 1.41421, 4);
